	...
	<div id="wrapper">
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a
							...
							class="active side_a_center"><i class="fa fa-weibo"></i>&nbsp;预约图书</a></li>
					</ul>
				</div>
			</div>
			<!-- 左侧列表end-->
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" method="get"
						action="${pageContext.request.contextPath }/findOrderBook.action">
						<div class="form-group">
							<label for="word">预约图书关键词</label> <input type="text"
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">预约图书列表</div>
								...
								<c:forEach items="${pagemsg.lists}" var="row">
									<tr>
										...
										<td><a href="#" class="btn btn-primary btn-xs"
											onclick="orderBook({bid:'${row.bid}',status:'${row.status}'})">预约</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
					...
					<div id="pagetable">
						<span class="page_center"> <c:if
								...
								<a
									href="${pageContext.request.contextPath }/findOrderBook?currentPage=1">[首页]</a>
								<a
									href="${pageContext.request.contextPath }/findOrderBook?currentPage=${pagemsg.currPage-1}">[上一页]</a>
							</c:if> <c:if test="${pagemsg.currPage != pagemsg.totalPage}">
								<a
									href="${pageContext.request.contextPath }/findOrderBook?currentPage=${pagemsg.currPage+1}">[下一页]</a>
								<a
									href="${pageContext.request.contextPath }/findOrderBook?currentPage=${pagemsg.totalPage}">[尾页]</a>
							</c:if>
		...
		<script type="text/javascript">
			function orderBook(parm) {
				$.post("${pageContext.request.contextPath}/isOrder.action", {
					"bid" : parm.bid,
					"status" : parm.status
				}, function(data) {
					if (data == "OK") {
