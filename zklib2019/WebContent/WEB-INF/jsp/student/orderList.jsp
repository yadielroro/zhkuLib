				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a
							...
							class="active side_a_center"><i class="fa fa-apple"></i>&nbsp;预约记录</a></li>
						<li><a
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">预约项目列表</div>
					...
					<div id="pagetable">
						<span class="page_center"> <c:if
								...
								<a
									href="${pageContext.request.contextPath }/orderList.action?currentPage=1">[首页]</a>
								<a
									href="${pageContext.request.contextPath }/orderList.action?currentPage=${pagemsg.currPage-1}">[上一页]</a>
							</c:if> <c:if test="${pagemsg.currPage != pagemsg.totalPage}">
								<a
									href="${pageContext.request.contextPath }/orderList.action?currentPage=${pagemsg.currPage+1}">[下一页]</a>
								<a
									href="${pageContext.request.contextPath }/orderList.action?currentPage=${pagemsg.totalPage}">[尾页]</a>
							</c:if>
